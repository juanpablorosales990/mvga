...
// These are generated by Anchor from sighash("global:initialize_escrow"), etc.
// They'll be validated at runtime by the program. If you change instruction
// names in the Rust program, regenerate these with:
//   anchor idl parse --file programs/mvga-escrow/src/lib.rs
const DISCRIMINATORS = {
  initializeEscrow: Buffer.from([0xde, 0x8e, 0xaa, 0x05, 0x96, 0xab, 0x82, 0x97]),
  markPaid: Buffer.from([0x44, 0x5e, 0xba, 0x78, 0x4c, 0x28, 0x65, 0x33]),
  releaseEscrow: Buffer.from([0xd7, 0x69, 0x1e, 0x88, 0xf4, 0xd6, 0xa3, 0x08]),
  refundEscrow: Buffer.from([0xd5, 0xe5, 0x4e, 0x62, 0x0d, 0x59, 0x27, 0x67]),
  fileDispute: Buffer.from([0xd2, 0x34, 0x47, 0x1f, 0xce, 0x8a, 0x5c, 0x26]),
  resolveDispute: Buffer.from([0xb6, 0xe3, 0x12, 0xac, 0x84, 0x07, 0xde, 0x90]),
};
